<script>
  ...
  // if today is a date in 2025, in the month of december, on or after the 22nd
  // OR today is a date in 2026, in the month of january, on or before the 2nd
  if (
    (today.getFullYear() == 2025 && today.getMonth() == 11 && today.getDate() >= 22) ||
    (today.getFullYear() == 2026 && today.getMonth() == 0 && today.getDate() <= 2)
  ) {
    winterBreak = true;
  }
